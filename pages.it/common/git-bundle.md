...
- Verifica che un file bundle sia valido e possa essere applicato alla repository in uso:
...
- Dato un file bundle, estrai un ramo specifico nella repository in uso:
