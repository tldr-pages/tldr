...
`git svn clone {{https://example.com/repo_subversion}} {{directory_locale}}`

- Clona un repository SVN a partire da uno specifico numero di revisione:

`git svn clone {{[-r|--revision]}} {{1234}}:HEAD {{https://svn.example.net/subversion/repo}} {{directory_locale}}`
