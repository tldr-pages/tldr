...
> Perintah ini merujuk kepada PowerShell versi 6 ke atas (juga dikenal sebagai PowerShell Core dan PowerShell lintas sistem operasi).
> Gunakan perintah `powershell` daripada `pwsh` untuk menggunakan PowerShell versi bawaan Windows (5.1 ke bawah).
