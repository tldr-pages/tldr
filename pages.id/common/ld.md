...
`ld {{jalan/menuju/berkas.o}} --output {{jalan/menuju/output_executable}}`

- Menghubungkan 2 file obyek berbarengan:

`ld {{jalan/menuju/berkas1.o}} {{jalan/menuju/berkas2.o}} --output {{jalan/menuju/output_executable}}`

- Menghubungkan secara dinamis sebuah program x86_64 ke glibc (jalan-jalan file berubah bergantung pada sistem):

`ld --output {{jalan/menuju/output_executable}} --dynamic-linker /lib/ld-linux-x86-64.so.2 /lib/crt1.o /lib/crti.o -lc {{jalan/menuju/berkas.o}} /lib/crtn.o`
