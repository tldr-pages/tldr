...
`todoist {{[a|add]}} "{{o_sarcină}}"`

- Adaugă o sarcină cu prioritate ridicată cu o etichetă, proiect și dată scadentă:

`todoist {{[a|add]}} "{{o_sarcină}}" --priority {{1}} --label-ids "{{idul_etichetei}}" --project-name "{{numele_proiectului}}" --date "{{tmr 9am}}"`

- Adaugă o sarcină cu prioritate ridicată cu o etichetă, proiect și dată scadentă, folosind modul rapid:

`todoist {{[q|quick]}} '#{{numele_proiectului}} "{{tmr 9am}}" p{{1}} {{o_sarcină}} @{{numele_etichetei}}'`
...
`todoist {{[l|list]}} --filter '(@{{numele_etichetei}} | {{today}}) & p{{1}}'`
