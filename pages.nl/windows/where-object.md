...
- Toon een lijst van alle services die momenteel zijn gestopt. De `$_` automatische variabele representeert ieder object dat wordt gestuurd naar de `Where-Object` cmdlet:
