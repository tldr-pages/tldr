...
- Maak verbinding met een lokale database op poort 3306, met de gebruikersnaam van de huidige gebruiker:

`mycli {{database_naam}}`

- Maak verbinding met een database (gebruiker wordt gevraagd om een wachtwoord):

`mycli {{[-u|--user]}} {{gebruikersnaam}} {{database_naam}}`

- Maak verbinding met een database op een andere host:
