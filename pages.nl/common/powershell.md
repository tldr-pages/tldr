...
> Het originele `powershell` commando in Windows is nog steeds beschikbaar om gebrukk te maken van de legacy Windows versie van PowerShell (versie 5.1 en lager).
