...
- Download de inhoud van een URL naar een bestand dat wordt aangegeven door de URL ("foo" in dit geval):

`wcurl {{https://example.com/foo}}`

- Download de inhoud van een URL naar een bestand met een opgegeven naam:

`wcurl {{[-o|--output]}} {{pad/naar/bestand}} {{https://example.com/foo}}`
