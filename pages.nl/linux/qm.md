...
- Maak een virtual machine aan met een 4 GB SCSI-schijf op de `local-lvm`-opslag en een ID van 100, gebruikmakend van een ISO-bestand die op de `local`-opslag is geüpload:
