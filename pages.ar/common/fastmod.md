...
- استبدال متجاهلا حالة الحرف في ملف حتى لو مُتجاهَلٌ أو في ملفات مسار مستبعدا المُتجاهَل منها بـ .ignore أو .gitignore
...
- امتدادهم استبدال بالنص مُطابقةً (وليس التعبيرات النمطية)، في ملفات .js أو.json فحسب:

`fastmod --fixed-strings {{نص_مطابِق}} {{بديل}} -e {{json,js}}`

- استبدال بجميع النصوص مُطابقةً، مباشرة دون تأكيد:
