...
`todoist {{[a|add]}} "{{பணி_பெயர்}}"`

- லேபிள், திட்டம் மற்றும் நிலுவைத் தேதியுடன் அதிக முன்னுரிமை பணியைச் சேர்க்கவும்:

`todoist {{[a|add]}} "{{பணி_பெயர்}}" --priority {{1}} --label-ids "{{லேபிள்_ஐடி}}" --project-name "{{திட்டத்தின்_பெயர்}}" --date "{{நாளை காலை 9 மணி}}"`

- Aவிரைவு பயன்முறையில் லேபிள், திட்டப்பணி மற்றும் நிலுவைத் தேதியுடன் அதிக முன்னுரிமைப் பணியைச் சேர்க்கவும்:

`todoist {{[q|quick]}} '#{{திட்டத்தின்_பெயர்}} "{{நாளை காலை 9 மணி}}" p{{1}} {{பணி_பெயர்}} @{{லேபிள்_பெயர்}}'`
...
`todoist {{[l|list]}} --filter '(@{{லேபிள்_பெயர்}} | {{இன்று}}) & p{{1}}'`
