...
`sudo pacman --remove --recursive {{தொகுப்பு_பெயர்}}`

- ஒரு தொகுப்பு மற்றும் அதன் சார்புகள் மற்றும் கட்டமைப்பு கோப்புகள் இரண்டையும் அகற்றவும்:

`sudo pacman --remove --recursive --nosave {{தொகுப்பு_பெயர்}}`

- கேட்காமல் ஒரு தொகுப்பை அகற்றவும்:

`sudo pacman --remove --noconfirm {{தொகுப்பு_பெயர்}}`
