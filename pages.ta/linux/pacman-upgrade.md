...
`sudo pacman -U {{நிரல்தொகுப்பு1.pkg.tar.zst/பாதை நிரல்தொகுப்பு2.pkg.tar.zst/பாதை ...}}`

- கேட்காமல் ஒரு தொகுப்பை நிறுவவும்:

`sudo pacman -U --noconfirm {{நிரல்தொகுப்பு.pkg.tar.zst/பாதை}}`

- தொகுப்பு நிறுவலின் போது முரண்பட்ட கோப்புகளை மேலெழுதவும்:

`sudo pacman -U --overwrite {{கோப்பு/பாதை}} {{நிரல்தொகுப்பு.pkg.tar.zst/பாதை}}`

- சார்பு பதிப்பு சரிபார்ப்புகளைத் தவிர்த்து, தொகுப்பை நிறுவவும்:

`sudo pacman -Ud {{நிரல்தொகுப்பு.pkg.tar.zst/பாதை}}`

- பாதிக்கப்படக்கூடிய தொகுப்புகளைப் பட்டியலிடுங்கள் (எந்த தொகுப்புகளையும் நிறுவாது):

`pacman -Up {{நிரல்தொகுப்பு.pkg.tar.zst/பாதை}}`
