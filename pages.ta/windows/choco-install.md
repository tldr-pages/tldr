...
`choco install {{நிரல்தொகுப்பு}} {{[-y|--yes]}}`

- தொகுப்புகளைப் பெற தனிப்பயன் மூலத்தைக் குறிப்பிடவும்:

`choco install {{நிரல்தொகுப்பு}} {{[-s|--source]}} {{மூல_முகவரி|alias}}`

- அங்கீகாரத்திற்கான பயனர்பெயர் மற்றும் கடவுச்சொல்லை வழங்கவும்:

`choco install {{நிரல்தொகுப்பு}} {{[-u|--user]}} {{பயனர்பெயர்}} {{[-p|--password]}} {{கடவுச்சொல்}}`
