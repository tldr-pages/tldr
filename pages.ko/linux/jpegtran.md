...
`jpegtran {{[-f|-flip]}} {{horizontal|vertical}} {{경로/대상/이미지.jpg}} > {{경로/대상/출력.jpg}}`

- 이미지를 시계 방향으로 90, 180 또는 270도 회전:

`jpegtran {{[-ro|-rotate]}} {{90|180|270}} {{경로/대상/이미지.jpg}} > {{경로/대상/출력.jpg}}`
...
`jpegtran {{[-g|-grayscale]}} {{경로/대상/이미지.jpg}} > {{경로/대상/출력.jpg}}`
