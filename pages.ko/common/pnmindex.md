...
`pnmindex {{[-s|-size]}} {{50}} {{경로/대상/입력1.pnm 경로/대상/입력2.pnm ...}} > {{경로/대상/출력.pnm}}`

- 한 행에 표시할 축소판 이미지의 개수 지정:

`pnmindex {{[-a|-across]}} {{10}} {{경로/대상/입력1.pnm 경로/대상/입력2.pnm ...}} > {{경로/대상/출력.pnm}}`

- 출력 이미지의 최대 색상 수 지정:

`pnmindex {{[-c|-colors]}} {{512}} {{경로/대상/입력1.pnm 경로/대상/입력2.pnm ...}} > {{경로/대상/출력.pnm}}`
