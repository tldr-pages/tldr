...
`pnmtopalm {{[-dep|-depth]}} {{1|2|4|8|16}} {{경로/대상/파일.pnm}} > {{경로/대상/파일.palm}}`
...
`pnmtopalm {{[-c|-colormap]}} {{경로/대상/파일.pnm}} > {{경로/대상/파일.palm}}`

- 비트맵의 밀도 지정:

`pnmtopalm {{[-den|-density]}} {{72|108|144|216|288}} {{경로/대상/파일.pnm}} > {{경로/대상/파일.palm}}`
