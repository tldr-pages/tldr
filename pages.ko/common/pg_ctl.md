...
`pg_ctl {{[-D|--pgdata]}} {{데이터_디렉토리}} init`

- PostgreSQL 서버 시작:

`pg_ctl {{[-D|--pgdata]}} {{데이터_디렉토리}} start`

- PostgreSQL 서버 중지:

`pg_ctl {{[-D|--pgdata]}} {{데이터_디렉토리}} stop`

- PostgreSQL 서버 재시작:

`pg_ctl {{[-D|--pgdata]}} {{데이터_디렉토리}} restart`

- PostgreSQL 서버 설정 다시 로드:

`pg_ctl {{[-D|--pgdata]}} {{데이터_디렉토리}} reload`
