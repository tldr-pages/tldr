...
`install {{[-o|--owner]}} {{사용자}} {{경로/대상/원본_파일1 경로/대상/원본_파일2 ...}} {{경로/대상/목표}}`

- 파일들을 목표에 복사하고 그룹 소유권 설정:

`install {{[-g|--group]}} {{사용자}} {{경로/대상/원본_파일1 경로/대상/원본_파일2 ...}} {{경로/대상/목표}}`

- `mode`를 설정하고 파일들을 목표에 복사:

`install {{[-m|--mode]}} {{+x}} {{경로/대상/원본_파일1 경로/대상/원본_파일2 ...}} {{경로/대상/목표}}`

- 파일들을 목표에 복사하고 원본의 접근/수정 시간 적용:

`install {{[-p|--preserve-timestamps]}} {{경로/대상/원본_파일1 경로/대상/원본_파일2 ...}} {{경로/대상/목표}}`
