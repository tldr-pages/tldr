...
MSG_MORE_INFO='The page `%s` has a more info link that does not match compared to the English page. Please check the "More information:" translation as well using https://github.com/tldr-pages/tldr/blob/main/contributing-guides/translation-templates/more-info-link.md.\n'
MSG_PAGE_TITLE='The page `%s` has a page title that does not match compared to the English page.\n'
