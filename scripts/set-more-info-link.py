...
Note: If the current directory or one of its parents is named "tldr", the script will assume it is the tldr root, i.e., the directory that contains a clone of https://github.com/tldr-pages/tldr. If you aren't, the script will use TLDR_ROOT as the tldr
