...
> A Kakoune egy mód-alapú kódszerkesztő, amely a "többszörös kiválasztás" paradigmáját valósítja meg.
> Az adatokat többszörös kiválasztással lehet kijelölni és egyszerre szerkeszteni különböző helyeken; a felhasználók ugyanabba a munkamenetbe is kapcsolódhatnak a közös szerkesztéshez.
> További információ: <https://kakoune.org>.
