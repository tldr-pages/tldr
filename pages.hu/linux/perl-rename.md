...
> Több fájl átnevezése. MEGJEGYZÉS: ez az oldal a `perl-rename` Arch Linux csomagban található parancsra hivatkozik. További információ: <https://manned.org/rename>.
