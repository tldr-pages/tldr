...
`addr2line {{[-e|--exe]}} {{ruta/a/ejecutable}} {{dirección}}`

- Muestra el nombre de la función, nombre de archivo y número de línea:

`addr2line {{[-e|--exe]}} {{ruta/a/ejecutable}} {{[-f|--functions]}} {{dirección}}`

- Decodifica (demangle) el nombre de la función para código C++:

`addr2line {{[-e|--exe]}} {{ruta/a/ejecutable}} {{[-f|--functions]}} {{[-C|--demangle]}} {{dirección}}`
