...
`qm {{[g|guest]}} exec {{100}} {{comando}} {{primer_argumento segundo_argumento ...}}`

- Ejecuta una orden específica a través de un agente huésped asincrónicamente:

`qm {{[g|guest]}} exec {{100}} {{primer_argumento segundo_argumento ...}} --synchronous 0`

- Ejecuta una orden específica a través de un agente huésped con un tiempo máximo de 10 segundos:

`qm {{[g|guest]}} exec {{100}} {{primer_argumento segundo_argumento...}} --timeout {{10}}`
...
`qm {{[g|guest]}} exec {{100}} {{primer_argumento segundo_argumento ...}} --pass-stdin 1`
