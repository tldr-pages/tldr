...
- Compila un archivo MPGL en un archivo de salida específico, sobrescribiéndolo si ya existe:

`xml2man -f {{ruta/al/fichero_funcion.mxml}} {{ruta/al/archivo_de_función.3}}`
