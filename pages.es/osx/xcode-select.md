...
> Cambia entre diferentes versiones de Xcode tanto como las herramientas para desarrolladores incluidas.
...
`xcode-select --switch {{ruta/al/archivoXcode.app}}`

- Imprime el directorio de desarrollador seleccionado:
