...
`d2 {{[-w|--watch]}} {{ruta/al/archivo_de_entrada.d2}} {{ruta/al/archivo_de_salida.ext}}`
...
`d2 {{[-t|--theme]}} {{identificador_tema}} {{ruta/al/archivo_de_entrada.d2}} {{ruta/al/archivo_de_salida.ext}}`

- Haz que los diagramas renderizados parezcan bocetos hechos a mano:

`d2 {{[-s|--sketch]}} true {{ruta/al/archivo_de_entrada.d2}} {{ruta/al/archivo_de_salida.ext}}`
