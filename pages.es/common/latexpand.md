...
`latexpand {{[-o|--output]}} {{ruta/a/salida.tex}} {{ruta/al/archivo.tex}}`

- No elimina los comentarios:

`latexpand --keep-comments {{[-o|--output]}} {{ruta/a/salida.tex}} {{ruta/al/archivo.tex}}`

- No expande `\include`s, `\input`s etc.:

`latexpand --keep-includes {{[-o|--output]}} {{ruta/a/salida.tex}} {{ruta/al/archivo.tex}}`

- Expande `\usepackage`s hasta encontrar los archivos STY correspondientes:

`latexpand --expand-usepackage {{[-o|--output]}} {{ruta/a/salida.tex}} {{ruta/al/archivo.tex}}`

- Incorpora el archivo BBL especificado:

`latexpand --expand-bbl {{ruta/a/bibliografía.bbl}} {{[-o|--output]}} {{ruta/a/salida.tex}} {{ruta/al/archivo.tex}}`
