...
- Imprimir una tabla de usuarios con UID >=1000 con encabezado y salida formateada, utilizando dos puntos como separador (`%-20s` significa: cadena de 20 caracteres alineada a la izquierda; `%6s` significa: cadena de 6 caracteres alineada a la derecha):
