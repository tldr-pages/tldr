...
- Compila el archivo fuente especificado en un ejecutable con el nombre especificado:

`pabcnetcclear /Output:{{ruta\al\_archivo.exe}} {{ruta\al\archivo_fuente.pas}}`

- Compila el archivo fuente especificado en un ejecutable con el mismo nombre junto con/sin información de depuración:

`pabcnetcclear /Debug:{{0|1}} {{ruta\al\archivo_fuente.pas}}`

- Permite que las unidades se busquen en la ruta especificada mientras se compila el archivo fuente en un ejecutable con el mismo nombre:

`pabcnetcclear /SearchDir:{{ruta\al\directorio}} {{ruta\al\archivo_fuente.pas}}`

- Compila el archivo fuente especificado en un ejecutable, definiendo un símbolo:
