...
> Crea un nuevo archivo, directorio, enlace simbólico o una entrada de registro.
...
- Crea un nuevo archivo en blanco (equivalente a `touch`):
...
- Crea un enlace simbólico\enlace duro\unión a un archivo o directorio:
