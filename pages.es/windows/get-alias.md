...
- Lista todos los alias en la sesión actual:
...
- Lista todos los alias asignados a un comando específico:

`Get-Alias -Definition {{comando}}`

- Lista alias que comienzan con `abc`, excluyendo aquellos que terminan en `def`:
