...
> Pour les commandes équivalentes dans d'autres gestionnaires de paquets, voir : [https://wiki.archlinux.org/title/Pacman/Rosetta](https://wiki.archlinux.org/title/Pacman/Rosetta).  
> Plus d'informations : [https://dnf.readthedocs.io](https://dnf.readthedocs.io).
