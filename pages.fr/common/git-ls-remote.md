...
- Affiche les références du dépôt configuré par défaut :

`git ls-remote`

- Affiche uniquement les références HEAD du dépôt configuré par défaut :

`git ls-remote --heads`

- Affiche uniquement les tags du dépôt configuré par défaut :

`git ls-remote {{[-t|--tags]}}`

- Affiche les références du dépôt précisé :

`git ls-remote {{url-du-dépôt}}`

- Affiche les références du dépôt précisé filtrés par un motif :
