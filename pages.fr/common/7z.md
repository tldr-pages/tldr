...
`7z a {{archive.7z}} {{chemin/vers/fichier_ou_répertoire}}`
...
`7z a -t{{7z|bzip2|gzip|lzip|tar|zip}} {{archive}} {{chemin/vers/fichier_ou_répertoire}}`
...
`7z a {{archive.7z}} -mx={{0|1|3|5|7|9}} {{chemin/vers/fichier_ou_répertoire}}`
