...
- Inform [social media managers](https://github.com/tldr-pages/access) to post about the client specification release on Mastodon and inform the wider community about the release.
