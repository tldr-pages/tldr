...
- عند كتابة ضغطات المفاتيح المتزامنة، حافظ على الترتيب التالي: `<Ctrl Super Windows Alt AltGr Shift everything_else>`.
...
- للحفاظ على التناسق، نفضل الصياغة العامة `Display help` و `Display version` لهذه الأوامر.
