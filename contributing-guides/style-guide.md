...
If a program requires root privileges to run and doesn't provide its own prompt for it like `systemctl`, prepend the command with `sudo`. (i.e `sudo apt update`)
