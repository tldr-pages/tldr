...
Try to match the page filename as close to the the invoked command as reasonable. Do not use the project name if possible. The goal is to be as transparent as possible to the user when they are curious of a command.
