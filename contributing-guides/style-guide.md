...
- If we are talking about unsplittable objects written together like a collection of
  zero or more characters then plural noun must be used like `{{characters}}`.
