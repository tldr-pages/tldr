...
- [Go client](https://github.com/leighmcculloch/tldr):
  - `go get 4d63.com/tldr`
  - `brew install leighmcculloch/tldr/tldr` or [platform binaries](https://github.com/leighmcculloch/tldr/releases)
- iOS clients:
