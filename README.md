...
- Go clients:
  ...
  - [4d63.com/tldr](https://4d63.com/tldr): `go get 4d63.com/tldr` or `brew install 4d63/tap/tldr` or [platform binaries](https://github.com/leighmcculloch/tldr/releases)
- iOS clients:
