...
- [Discord Slash Command Bot](https://github.com/Epictek/tldr-Discord): `dotnet run` or use [hosted instance](https://discord.com/api/oauth2/authorize?client_id=839254228736278579&permissions=0&scope=applications.commands%20bot)
- Docker images:
