...
`docker exec {{[-it|--interactive --tty]}} --workdir {{caminho/para/diretório}} {{nome_do_contêiner}} {{comando}}`
...
`docker exec {{[-it|--interactive --tty]}} --env {{nome_da_variável}}={{valor}} {{nome_do_contêiner}} {{/bin/bash}}`
