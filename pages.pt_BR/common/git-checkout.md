...
- Cria e muda para uma nova branch com base em uma referência específica (branch, remote/branch, tag são exemplos de referências válidas)
...
- Substitui um arquivo no diretório atual com a versão confirmada em uma determinada branch:
