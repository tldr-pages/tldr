...
- Restaura arquivos correspondentes a determinados arquivos regex ([c]ase-insensitive) a serem restaurados de um sistema de arquivos btrfs (todos os diretórios pai do(s) arquivo(s) de destino também devem corresponder):
