...
- Adiciona um repositório e atualizar o cache do(s) pacote(s) deste repositório:

`add-apt-repository --update {{especificacao_do_repositorio}}`

- Adiciona um repositório e habilitar o download do código fonte do(s) pacote(s) deste repositório:
