...
`sudo dd status=progress if={{caminho/para/arquivo.iso}} of={{/dev/dispositivo_usb}}`
...
`sudo dd status=progress if={{/dev/dispositivo_de_origem}} of={{caminho/para/arquivo.img}}`
