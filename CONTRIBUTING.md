...
1. If specifying less than 5 makes more sense due to, for example, the command's scope being quite narrow, it's fine to 
   do so; however, at least 1 example should always be present.
