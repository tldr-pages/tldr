...
> If `--prefix` is omitted, the image files must be located in the working directory.
...
- Create an X cursor file using a config file and write the output to standard output:
