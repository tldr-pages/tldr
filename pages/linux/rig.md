...
> Utility to piece together a random first name, last name, street number, and address, along with a geographically consistent (i.e. they all match the same area) city, state, ZIP code, and area code.
