...
> Tool to import and remove rpm keys of for rpm resopsitories.
> When adding a rpm respository then you also must import the correspondig rpm key.
...
- Import a rpm key of respository:
