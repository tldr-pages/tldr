...
> GNU datamash performs basic numeric, textual and statistical operations on input textual data files.

- Get max, min, mean and median of a single column of numbers:

`seq 3 | datamash max 1 min 1 mean 1 median 1`

- Get the mean of a single column of float numbers (floats must use `,` instead of `.`):
