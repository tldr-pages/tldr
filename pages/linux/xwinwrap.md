...
`xwinwrap -b -nf -ov -- mpv -wid WID --loop --no-audio --no-resume-playback --panscan=1.0 video.mp4`

- Run a video in fullscreen using mpv:

`xwinwrap -b -nf -fs -ov -- mpv -wid WID --loop --no-audio --no-resume-playback --panscan=1.0 video.mp4`
