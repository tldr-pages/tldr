...
- Create a new repo backed by a clone of a Git repo (the default directory is the repository name):

`jj git clone {{source}}`

- Create a new repo backed by a clone of a Git repo in a specific directory:
