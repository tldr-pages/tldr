...
`textql -header -sql "SELECT * FROM {{path/to/file1}} JOIN {{path/to/file2}} ON {{path/to/file1}}.{{c1}} = {{path/to/file2}}.{{c1}} LIMIT {{10}}" -output-header {{path/to/file1.csv}} {{path/to/file2.csv}}`
