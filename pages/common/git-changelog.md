...
- List a range of commits from 2.1.0 to now:

`git changelog --list --start-tag 2.1.0`

- List pretty formatted range of commits between 0.5.0 and 1.0.0:

`git changelog --start-tag 0.5.0 --final-tag 1.0.0`

- List pretty formatted range of commits between 0b97430 and 1.0.0:
