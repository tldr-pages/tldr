...
`d2 {{path/to/input_file.d2}} {{path/to/output_file.svg|path/to/output_file.[svg|png]}}`

- [w]atch live changes made to a D2 source file in the default web browser:

`d2 --watch {{path/to/input_file.d2}} {{path/to/output_file.svg|path/to/output_file.[svg|png]}}`
...
`d2 --theme {{theme_id}} {{path/to/input_file.d2}} {{path/to/output_file.svg|path/to/output_file.[svg|png]}}`

- Make rendered diagrams look like hand [s]ketches:

`d2 --sketch true {{path/to/input_file.d2}} {{path/to/output_file.svg|path/to/output_file.[svg|png]}}`
