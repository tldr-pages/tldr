...
- Create a shaded scatter plot of points and save it to a png file, set the background color to black:

`datashader_cli points {{path/to/input.parquet}} --x {{pickup_x}} --y {{pickup_y}} {{path/to/output.png}} --background black`

- Visualize the geospatial data, support Geoparquet, shapefile, geojson, geopackage, etc:
