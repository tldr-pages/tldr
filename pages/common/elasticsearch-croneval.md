...
> Validates and evaluates a cron expression. This command helps verify that your cron expressions are valid for use with Elasticsearch and produce the expected results.
