...
> লগে পাওয়া ভায়োলেশনের ভিত্তিতে অ্যাপআর্মরের (AppArmor) সিকিউরিটি প্রোফাইল ইন্টারযাকটিভভাবে আপডেট করুন।
> আরও তথ্য পাবেন: <https://gitlab.com/apparmor/apparmor/-/wikis/manpage_aa-logprof.8>।

- সিস্টেম লগ অনুযায়ী ইন্টারযাকটিভভাবে প্রোফাইল রিভিউ ও আপডেট করুন:
