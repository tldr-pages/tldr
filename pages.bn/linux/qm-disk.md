...
`qm {{[di|disk]}} {{[resi|resize]}} {{100}} {{ডিস্কের_নাম}} +{{n}}G`

- একটি ভার্চুয়াল ডিস্ক মুভ করুন:

`qm {{[di|disk]}} {{[m|move]}} {{100}} {{গন্তব্য}} {{ইনডেক্স}}`

- ভার্চুয়াল ডিস্কের পূর্ববর্তী কপি ডিলিট করুন:

`qm {{[di|disk]}} {{[m|move]}} --delete {{100}} {{গন্তব্য}} {{ইনডেক্স}}`

- একটি নির্দিষ্ট স্টোরেজ নাম ব্যবহার করে একটি VMDK/`.qcow2`/raw ডিস্ক ইমেজ ইম্পোর্ট করুন:

`qm {{[di|disk]}} {{[i|import]}} {{100}} {{ডিস্ক/এর/পাথ}} {{স্টোরেজ_নাম}} --format {{qcow2|raw|vmdk}}`
