...
- Установить время [д]оступа или [м]одификации файла на текущее, не создавая файл, если он не существует:

`touch {{[-c|--no-create]}} {{-a|-m}} {{путь/к/файлу1 путь/к/файлу2 ...}}`

- Установить [в]ремя файла на определённое значение, не создавая файл, если он не существует:
