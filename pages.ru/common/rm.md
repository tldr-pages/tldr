...
- Удалить файлы и директории рекурсивно:

`rm {{[-r|--recursive]}} {{путь/к/файлу_или_директории1 путь/к/файлу_или_директории2 ...}}`

- Удалить пустые директории (считается безопасным методом):

`rm {{[-d|--dir]}} {{путь/к/директории}}`
