...
- Вывести таблицу пользователей с UID >=1000 с заголовком и форматированным выводом, используя двоеточие в качестве разделителя (`%-20s` означает: 20 символов строки с выравниванием по левому краю, `%6s` означает: 6 символов с выравниванием по правому краю):
